...
| &nbsp;            | &nbsp;                                                                                                | &nbsp;                                                                                                                |
| &emsp;strip       | string **strip**(string_view sv \[, string_view set\])                                                | string with characters given in set stripped from left and right, default " \t\n"                                     |
